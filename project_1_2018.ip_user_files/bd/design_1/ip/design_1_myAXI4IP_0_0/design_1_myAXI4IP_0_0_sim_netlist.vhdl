...
M_AXI_ARADDR_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => axi_araddr_reg(15 downto 13),
      DI(0) => '0',
...
M_AXI_AWADDR_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => axi_awaddr_reg(15 downto 13),
      DI(0) => '0',
...
\axi_araddr[11]_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\axi_awaddr[11]_i_6\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\axi_awaddr[11]_i_7\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"2"
    )
        port map (
...
\axi_awaddr_reg[11]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \axi_awaddr[11]_i_4_n_0\,
      S(2) => \axi_awaddr[11]_i_5_n_0\,
      S(1) => \axi_awaddr[11]_i_6_n_0\,
      S(0) => \axi_awaddr[11]_i_7_n_0\
    );
